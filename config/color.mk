...
COLOR_FUCHSIA       := $(COLOR)13m# Hồng cánh sen / Tím sáng (Thay cho Pink)
...
GET_RGB_COLOR = $(COLOR)$(shell expr 36 \* $(or $(1),0) + 6 \* $(or $(2),0) + $(or $(3),0) + 16)m

# ==[ DẢI QUANG PHỔ XÁM ĐƠN SẮC ]=======================================
# Cú pháp gọi trong makefile: $(call GET_GRAY_LEVEL, LEVEL) [Với LEVEL từ 0 đến 23]
GET_GRAY_LEVEL = $(COLOR)$(shell expr $(or $(1),0) + 232)m
